...
- Описание. Suffix Tree - дерево, в котором содержатся  все возможные окончания слова.
- Применение. Suffix Tree позволяет реализовывать многие быстрые, важные операции со строками.
